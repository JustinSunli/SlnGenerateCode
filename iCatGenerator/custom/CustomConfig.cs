...
namespace iCatGenerator.custom
{
    public class CustomConfig
    {
        ...
        private static String _appName = "iCat代码生成器";
        private static object _EnableAutoStartService = false;

        public const String DevCompanyName = "ICat科技";
        public const String Developer = "lifengyan";
        public const String HelpTelephone = "15652283960";
        public const String DevStartDate = "2014-08-01";
